...
class choice {
  ...
  not(itemElement) {
    ...
    var dsval = this.initial.querySelectorAll("option")[arr].textContent;
    this.sVal = this.sVal.filter((value) => value !== dsval);;
  }
  ...
  upslot() {
    ...
    if (chosenslo.length === 0) {
      ...
      var hour1 = one.substring(0, 9);
      var hourend = final.substring(11); //getting the time together
